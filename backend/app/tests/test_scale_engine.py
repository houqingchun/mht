...
def test_all_yes_scores_ninety_excluding_validity():
    """全部答「是」：内容题总分 90、效度分 10。"""
...
def test_only_validity_questions_do_not_count_toward_the_total():
    """只答效度题：总分仍为 0，效度分为 10。"""
    answer_map = answers()
