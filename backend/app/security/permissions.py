...
PROFESSIONAL_REPORT_READ = "PROFESSIONAL_REPORT_READ"
PROFESSIONAL_REPORT_EDIT = "PROFESSIONAL_REPORT_EDIT"
PROFESSIONAL_REPORT_PUBLISH = "PROFESSIONAL_REPORT_PUBLISH"
...
CAPABILITY_LABELS = {
    ...
    PROFESSIONAL_REPORT_READ: "专业报告查看",
    PROFESSIONAL_REPORT_EDIT: "专业报告编辑",
    PROFESSIONAL_REPORT_PUBLISH: "专业报告发布",
}
...
CAPABILITY_LEVELS: dict[str, list[str]] = {
    ...
    PROFESSIONAL_REPORT_READ: [NONE, SCOPED, SCHOOL],
    PROFESSIONAL_REPORT_EDIT: [NONE, SCOPED],
    PROFESSIONAL_REPORT_PUBLISH: [NONE, SCOPED],
}
...
LEVEL_DESCRIPTIONS: dict[str, dict[str, str]] = {
    ...
    PROFESSIONAL_REPORT_READ: {NONE: "不可查看专业报告", SCOPED: "查看授权范围内报告", SCHOOL: "查看全校已发布报告"},
    PROFESSIONAL_REPORT_EDIT: {NONE: "不可编辑专业报告", SCOPED: "编辑授权范围内报告"},
    PROFESSIONAL_REPORT_PUBLISH: {NONE: "不可发布专业报告", SCOPED: "发布授权范围内报告"},
}
...
CAPABILITY_DEFAULTS: dict[str, dict[RoleCode, str]] = {
    ...
    PROFESSIONAL_REPORT_READ: {
        RoleCode.COUNSELOR: SCOPED, RoleCode.LEADER: SCHOOL,
        RoleCode.ADMIN: NONE, RoleCode.STUDENT: NONE,
    },
    PROFESSIONAL_REPORT_EDIT: {
        RoleCode.COUNSELOR: SCOPED, RoleCode.LEADER: NONE,
        RoleCode.ADMIN: NONE, RoleCode.STUDENT: NONE,
    },
